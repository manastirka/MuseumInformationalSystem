...
// Овде је некад стајао списак ОТВОРЕНИХ падова (браон беџ/дугме/заглавље + крем
// текст) који су се прескакали, јер су падали и у СВЕТЛОЈ теми — дакле нису били
// баг тамне теме него глобални, а поправка мења изглед подразумеване светле.
// Та одлука је донета и heritage тонови су поправљени, па списак више не постоји
// и тест мери СВЕ. Види `kontrast-heritage.spec.js`.
